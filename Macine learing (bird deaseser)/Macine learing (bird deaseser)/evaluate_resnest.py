...
CONFIG = {
    ...
    'model_path': './resnest_poultry_results/best_resnest.pth',
...
def evaluate():
    ...
    model = timm.create_model('resnest50d', pretrained=False, num_classes=len(classes))
