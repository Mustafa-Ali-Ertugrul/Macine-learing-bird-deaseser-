#!/usr/bin/env python3
"""
ConvNeXt-Tiny Evaluation Script
"""
...
CONFIG = {
    ...
    'model_path': './convnext_poultry_results/final_model',
...
def evaluate():
    print("=" * 60)
    print("EVALUATION - ConvNeXt-Tiny")
    print("=" * 60)
    ...
    try:
        processor = ConvNextImageProcessor.from_pretrained(CONFIG['model_path'])
        model = ConvNextForImageClassification.from_pretrained(CONFIG['model_path'])
