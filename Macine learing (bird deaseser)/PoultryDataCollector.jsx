    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ol className="list-decimal ml-4 text-sm text-blue-800">
            <li>Yukarıdaki kaynaklardan arayın ve indirin</li>
            <li>İndirilen görüntüleri <code className="bg-white px-1 rounded">poultry_microscopy/</code> klasörüne kaydedin</li>
            <li>Her görüntü için metadata CSV dosyası oluşturun (tissue, magnification, disease, path)</li>
            <li>Etiketleme arayüzüne geçin (separate application)</li>
          </ol>
        </div>
      </div>
    </div>
