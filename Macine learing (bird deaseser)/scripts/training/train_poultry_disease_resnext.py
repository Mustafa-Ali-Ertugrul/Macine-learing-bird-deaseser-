...
def train_model():
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), 'best_poultry_disease_resnext.pth')
    ...
    # Save final model
    torch.save(model.state_dict(), 'final_poultry_disease_resnext.pth')
    print("✅ Final model saved as 'final_poultry_disease_resnext.pth'")
