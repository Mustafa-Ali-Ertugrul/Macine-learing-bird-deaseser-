...
DISEASE_SOURCES = {
    ...
    'infectious_bronchitis': {
        'keywords': ['infectious bronchitis', 'ibv', 'coronavirus', 'trachea'],
        'pubmed_queries': [
            'infectious bronchitis virus chicken histopathology',
            'ibv trachea microscopy',
            'avian coronavirus kidney pathology'
        ],
        'kaggle_dataset': 'chandrashekarnatesh/poultry-diseases',
        'description': 'Infectious Bronchitis - Coronavirus affecting respiratory/urogenital systems'
    },
    'infectious_bursal': {
        'keywords': ['infectious bursal disease', 'ibd', 'gumboro', 'birnavirus'],
        'pubmed_queries': [
            'infectious bursal disease histopathology',
            'gumboro disease bursa fabricius',
            'ibdv chicken microscopy'
        ],
        'kaggle_dataset': 'allandclive/poultry-disease-detection',
        'description': 'Infectious Bursal Disease (Gumboro) - Viral disease affecting the bursa'
    },
    'histomoniasis': {
        'keywords': ['histomoniasis', 'blackhead disease', 'histomonas meleagridis'],
        'pubmed_queries': [
            'histomoniasis chicken liver histopathology',
            'blackhead disease cecum microscopy',
            'histomonas meleagridis tissue'
        ],
        'kaggle_dataset': None,
        'description': 'Histomoniasis (Blackhead) - Protozoan disease affecting liver and ceca'
    },
    'fowl_pox': {
        'keywords': ['fowl pox', 'avian pox', 'poxvirus'],
        'pubmed_queries': [
            'fowl pox virus histopathology',
            'avian pox skin lesion microscopy',
            'fowl pox diphtheritic lesion'
        ],
        'kaggle_dataset': None,
        'description': 'Fowl Pox - Viral disease causing skin lesions'
    }
}
